...
namespace ContextLifeManager
{
    public class DbContextScope : IDbContextScope
    {
        ...
        public void RefreshEntitiesInParentScope<T>(T entity)
        {
            RefreshEntitiesInParentScope(new List<T> { entity });
        }
        ...
        public async Task RefreshEntitiesInParentScopeAsync<T>(T entity)
        {
            await RefreshEntitiesInParentScopeAsync(new List<T> { entity });
        }
